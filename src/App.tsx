          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                ...
                <div
                  ...
                  style={{ 
                    ...
                    borderColor: '#ff44ff',
                    boxShadow: '0 0 20px rgba(255, 68, 255, 0.3)'
                  }}
                >
                  {/* Mechanical details */}
                  <div className="absolute top-2 right-2 w-4 h-4 border-2 border-[#ff44ff] rounded-full opacity-60">
                    <div className="w-1 h-1 bg-[#ff44ff] rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
                  </div>
                  <div className="absolute bottom-2 left-2 flex gap-1">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="w-1 h-4 bg-[#ff44ff] opacity-40 rounded-full"></div>
                    ))}
                  </div>
                ...
                >
                  {/* Mechanical details */}
                  <div className="absolute top-2 right-2 w-4 h-4 border-2 border-[#ffa500] rounded-full opacity-60">
                    <div className="w-1 h-1 bg-[#ffa500] rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
                  </div>
                  <div className="absolute bottom-2 left-2 flex gap-1">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="w-1 h-4 bg-[#ffa500] opacity-40 rounded-full"></div>
                    ))}
                  </div>
                ...
                {/* NFT */}
                <div
                  onClick={() => window.open('https://nft.axiasi.com', '_blank')}
                  className="group p-6 rounded-xl border-2 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl relative overflow-hidden"
                  style={{ 
                ...
                >
                  {/* Mechanical details */}
                  <div className="absolute top-2 right-2 w-4 h-4 border-2 border-[#ffd700] rounded-full opacity-60">
                    <div className="w-1 h-1 bg-[#ffd700] rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
                  </div>
                  <div className="absolute bottom-2 left-2 flex gap-1">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="w-1 h-4 bg-[#ffd700] opacity-40 rounded-full"></div>
                    ))}
                  </div>
              ...
              <div className="flex justify-center gap-4 mt-8 relative z-10">
                {[
                  { name: 'FITNESS', color: '#00ff88' },
                  { name: 'GAME', color: '#ff44ff' },
                  { name: 'SHOP', color: '#ffa500' },
                  { name: 'NFT', color: '#ffd700' },
                  { name: 'RESEARCH', color: '#00bfff' },
                  { name: 'CLONING', color: '#8a2be2' }
                ].map((module, index) => (
                  <div key={index} className="text-center">
                    <div 
                      className="w-3 h-8 rounded-full mx-auto mb-1"
                      style={{
                        background: `linear-gradient(to top, ${module.color} 0%, transparent 100%)`,
                        opacity: 0.7,
                    ...
                    <div 
                      ...
                      style={{ color: module.color, opacity: 0.6 }}
                    >
                      {module.name}
                    </div>
                  </div>
